...
<!-- doccure/{{ route('dashboard.index') }}  30 Nov 2019 04:12:16 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										...
										<div class="profile-det-info">
											<?php
												$birthDate = strtotime(Auth::guard('web')->user()->dob);
											...
											@if(Auth::user()->dob !== NULL)
												<div class="patient-details">
													...
													@if(Auth::user()->state !== NULL)
														<h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> {{ Auth::user()->city}}, {{ Auth::user()->state }} </h5>
													@endif
												</div>
											@endif
										</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										<li><a href="{{ route('showSearch') }}"><i class="fas fa-angle-double-right"></i> Search for Doctors</a></li>
										<li><a href="login.html"><i class="fas fa-angle-double-right"></i> Login</a></li>
										<li><a href="register.html"><i class="fas fa-angle-double-right"></i> Register</a></li>
										<li><a href="booking.html"><i class="fas fa-angle-double-right"></i> Booking</a></li>
										<li><a href="{{ route('dashboard.index') }}"><i class="fas fa-angle-double-right"></i> Patient Dashboard</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
